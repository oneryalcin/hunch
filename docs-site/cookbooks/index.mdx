---
title: "Cookbooks"
description: "Seven real problems worked through with hunch, each with its spec, its numbers, and what did not work."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Check RAG answers against their sources" icon="file-magnifying-glass" href="/cookbooks/rag-answers">
    Passes 54% of 900 annotated answers as supported with 4 wrong, and ranks six models as the annotators do.
  </Card>
  <Card title="Read an NDA before a lawyer does" icon="file-contract" href="/cookbooks/nda-review">
    One word in the criteria fixed 21 of 61 contracts; still a first pass, not a decision.
  </Card>
