...
Work goes round this loop: `run` a spec, `review` a sample, `test`, then change the spec and `diff` to see what flipped. Your application can call the same spec with [`hunch.judge(...)`](/guides/use-in-your-app).
