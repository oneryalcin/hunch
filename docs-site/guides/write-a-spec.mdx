...
The first version of a question is rarely the best one, and every row asked under a changed question is paid for again. So run a sample first, review twenty rows, and test before you run everything. [Change a spec](/guides/change-a-spec) shows how to compare versions.
