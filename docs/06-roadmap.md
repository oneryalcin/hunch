...
Updated 2026-09-26. **Released:** `hunch-ai` on PyPI (import and CLI `hunch`): 0.1.0 on 2026-09-25, 0.2.0 adds `hunch skill`, `hunch docs` with exposures, contracts (the answers an app relies on) and `spec_from_agent`. Repo public (Apache 2.0; server ELv2), docs at fuguai.mintlify.site.
